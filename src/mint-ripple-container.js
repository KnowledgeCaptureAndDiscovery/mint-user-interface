...
$_documentContainer.innerHTML = `<dom-module id="mint-ripple-container">
...
class MintRippleContainer extends mixinBehaviors(
  [PaperRippleBehavior], PolymerElement) {

  static get is() { return 'mint-ripple-container'; }
...
customElements.define(MintRippleContainer.is, MintRippleContainer);
