...
import { GraphLinkConfig, GraphVariableConfig, GraphNodeConfig } from "./config/GraphItemConfig.js";

export function Template(id, store, editor) {
  this.id = id;
  this.editor = editor;
  ...
  this.store = null;
  this.events = new TemplateEvents(this, this.svg);
...
Template.prototype.calculateGraphSizeAfterMove = function(moveditems) {
  var maxx = this.graphsize.width,
    maxy = this.graphsize.height;
  var xpad = 20;
  var ypad = 20;
